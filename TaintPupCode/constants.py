...
FORBIDDEN_KEY_VALUES  = ['separator', 'version', 'map', 'backend', '_host', '_tenant', 'set_', '_service_name', 'keytype', '_buffer_size', 'revocation_interval', 'gpg_pub_', 'analytics_keyspace']  
ADMIN_KEYWORD = 'admin'
CONCAT_KEYWORD = 'cat'
