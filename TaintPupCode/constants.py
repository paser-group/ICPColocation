...
FORBIDDEN_USER_VALUES = ['domain', 'group', 'mode', 'schema', 'email', '_tenant', '_tree_dn', '_attribute', '_emulation', '_allow_', '_emulation'] 
FORBIDDEN_PASS_VALUES = ['_auth', '_file', '_path'] 
FORBIDDEN_KEY_VALUES  = ['separator', 'version', 'map', 'backend', '_host', '_tenant', 'set_', '_service_name', 'keytype', '_buffer_size', 'revocation_interval', 'gpg_pub_', 'analytics_keyspace', '_try_keyset', '_path', '_default', '_key_name', 'keyring', '_server']  
ADMIN_KEYWORD = 'admin'
CONCAT_KEYWORD = 'cat'
